...
//        t = ni();
        for (int ii = 0; ii < t; ii++) {
            ...
            for (int i = 0; i < n; i++) { f[i]= nw(); l[i]= nw(); }

            int[] a= ni(n);
            String prev= "A";
            for(int i: a) {
                int ind= i-1;
                if(f[ind].compareTo(l[ind])<= 0) {
                    if(f[ind].compareTo(prev)> 0) prev= f[ind];
                    else if(l[ind].compareTo(prev)> 0) prev= l[ind];
                    else { out.println("NO"); return; }
                }
                else {
                    if(l[ind].compareTo(prev)> 0) prev= l[ind];
                    else if(f[ind].compareTo(prev)> 0) prev= f[ind];
                    else { out.println("NO"); return; }
                }
            }
