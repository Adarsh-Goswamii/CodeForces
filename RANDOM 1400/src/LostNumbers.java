...
//        t = ni();
        for (int ii = 0; ii < t; ii++) {
            List<Integer> arr= new ArrayList<>(Arrays.asList(4, 8, 15, 16, 23, 42));
...
//            }
    ...
    private int query(int i, int j) throws Exception {
        out.println("? "+i+" "+j);
        out.flush();
        return ni();
    }
