...
public class MinimumTernaryString {
    ...
    void solve() throws Exception {
        ...
        int _1= 0, _0= 0;
        for(char c: a) if(c== '1') _1++;

        for(char c: a) {
            if(c== '2') {
                while(_0!= 0) { _0--; out.print(0); }
                while(_1!= 0) { _1--; out.print(1); }
                out.print(2);
            }
            else if(c== '0') _0++;
        }

        while(_0!= 0) { out.print(0); _0--; }
        while(_1!= 0) { out.print(1); _1--; }
        out.println();
    }

    public static void main(String[] args) throws Exception {
        new MinimumTernaryString().run();
    }
