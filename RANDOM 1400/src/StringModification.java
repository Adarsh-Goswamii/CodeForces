...
public class StringModification {
    ...
    void solve() throws Exception {
        ...
        for (int ii = 0; ii < t; ii++) {
            ...
            for (int k = 1; k <= n; k++) {
                StringBuilder sub= new StringBuilder(s.substring(0, k-1));
                StringBuilder ms= new StringBuilder();
                ms.append(s.substring(k-1, n));

                int val= n-k+1;
                if(val%2== 0) ms.append(sub);
                else ms.append(sub.reverse());
            ...
            for(int i=0;i<str.size();i++) {
                if(ans_k== -1 || ans.compareTo(str.get(i))>0) {
                    ans_k= i+1;
                    ans= str.get(i);
                }
            }
